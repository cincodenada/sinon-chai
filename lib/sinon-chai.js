...
(function (sinonChai) {
    ...
    function overwrittenSinonMethod(chaiName, shouldCallOriginal, action, nonNegatedSuffix) {
        var handler = createSinonMethodHandler(chaiName, action, nonNegatedSuffix);
        utils.overwriteMethod(chai.Assertion.prototype, chaiName, function (_super) {
            return function () {
                if (shouldCallOriginal(arguments)) {
    ...
    overwrittenSinonMethod("match", argumentIsType(RegExp), "match %1");
}));
